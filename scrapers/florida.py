...
#   json.dump(text, outfile)
    ...
    for pdf in pdfs:
        ...
        link_obj = {
            ...
            "course_code": filename_details_map[filename][0],
            "course_title": filename_details_map[filename][1],
            "text": pdf_text
        }
